...
Route::group(array('before'=>'api.csrf'),function(){
	...
	Route::post('/customattemp','LoginController@customattemp');
...
Route::group(array('prefix'=>'/','before'=>'auth.Ui|auth.token|api.csrf'),function(){
    ...
    Route::delete('/teachers/leaderBoard/{id}','TeachersController@leaderboardRemove');
    ...
    Route::delete('/students/leaderBoard/{id}','StudentsController@leaderboardRemove');
    Route::delete('/students/acYear/{student}/{id}','StudentsController@acYearRemove');
    ...
    //Study Material
	Route::get('/materials','StudyMaterialController@index');
	Route::get('/materials/listAll','StudyMaterialController@listAll');
	Route::delete('/materials/{id}','StudyMaterialController@delete');
    ...
    //Staff Attendance
	Route::get('/sattendance','SAttendanceController@listAll');
    ...
    Route::delete('/vacation/{id}','vacationController@delete');
	
	//Users
	Route::get('/users/getRoles','UsersController@getRoles');
	Route::get('/users/fetchRoles/{id}','UsersController@fetchRoles');
	
	//Permissions
	Route::get('/permissions/getPermissions/{id}','PermissionsController@getPermissions');
	Route::post('/permissions/update','PermissionsController@update');
	
	//Inventory
	Route::get('/inventory','InventoryController@index');
	Route::get('/inventory/listAll','InventoryController@listAll');
	Route::get('/inventory/listTeachersAll','InventoryController@listTeachersAll');
	Route::get('/inventory/listAll/{page}','InventoryController@listAll');
	Route::delete('/inventory/{id}','InventoryController@delete');
	Route::post('/inventory','InventoryController@create');
	Route::get('/inventory/{id}','InventoryController@fetch');
	Route::post('/inventory/{id}','InventoryController@edit');
	Route::get('/inventory/search/{keyword}/{page}','InventoryController@search');
});
