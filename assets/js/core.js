...
function loadAddNew(){
  $(".dialog-boxes > div").click(function(){
    ...
    buttons: [
  {
    ...
    resizable: false,
    create:function () {
                      $(this).parent().find('.ui-dialog-titlebar').append('<span class="fa fa-times-circle close-dialog"></span>');
                      $(this).parent().find('button').addClass('btn').addClass('btn-primary').addClass('btn-cons');
...
$( ".addnewbox" ).click(function() {
  ...
  fluidDialog();
    $("#select-category").select2().on("change", function(e) {
...
function loadCampus(){
  $(".mycampus_page").click(function(){
    window.location.href="campus/mycampus.html"
  });
